...
exports.NodeMouseTracker = void 0;
 ...
 */
class NodeMouseTracker extends base_tracker_1.BaseMouseTracker {
    constructor() {
        super();
        this.POLL_RATE = 60; // 60 FPS
        this.POLL_INTERVAL = 1000 / this.POLL_RATE;
...
exports.NodeMouseTracker = NodeMouseTracker;
