              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <div className={`w-3 h-3 rounded-full mr-3 ${getStatusColor(isElectronReady)}`}></div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-semibold text-gray-600">{getStatusText(appStatus?.modules.dragDetector || false)}</span>
                </div>
              </div>
            )}
          </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
            ...
            <div>
              ...
              <p><strong>Chrome Version:</strong> {process.versions.chrome}</p>
              <p><strong>V8 Version:</strong> {process.versions.v8}</p>
            </div>
          </div>
        </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-blue-700">
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 text-sm">
                <li><strong>Shake cursor:</strong> Quickly move mouse left-right to show shelf</li>
                <li><strong>Drag files:</strong> Drag files from anywhere to trigger shelves</li>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 text-sm">
                <li><strong>Smart detection:</strong> Advanced algorithms for gesture recognition</li>
                <li><strong>File management:</strong> Temporary storage for files and content</li>
