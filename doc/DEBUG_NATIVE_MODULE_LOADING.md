...
### 2. Using __dirname for Path Construction
```typescript
...
- **Never rely on __dirname** after webpack compilation
...
- **Set node: { __dirname: false }** to preserve original __dirname behavior where possible
